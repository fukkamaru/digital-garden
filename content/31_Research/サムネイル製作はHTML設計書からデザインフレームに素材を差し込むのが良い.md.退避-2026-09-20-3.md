...
- 初期のAI生成方式：[[サムネイル作成のプロンプト]]／[[HTMLからサムネイルを作ってもらうプロンプト]]
- 実際のローカルHTML/CSSとDevTools出力：[[thumbnail-production-workflow]]
- 縞鋼板案件での試行：[[thumbnail-creation-practice-part-2]]／[[thumbnail-creation-practice-part-3]]
- 用語と成果物の認識ずれ：[[thumbnail-production-terminology-communication-record|サムネイル制作で生じた用語と成果物の認識ずれ]]
